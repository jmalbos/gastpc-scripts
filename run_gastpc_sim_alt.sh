...
# echo 'setup genie v2_10_10 -q e10:prof:r6'                >> ${SCRIPT}
  ...
  echo '/gastpc/geometry/upstream_ecal_num_layers 1'                                >> ${G4MACRO}
  echo '/gastpc/geometry/upstream_ecal_scint_thickness 20. cm'                      >> ${G4MACRO}
  echo '/gastpc/geometry/downstream_ecal_num_layers 1'                              >> ${G4MACRO}
  echo '/gastpc/geometry/downstream_ecal_scint_thickness 20. cm'                    >> ${G4MACRO}
  echo '/gastpc/geometry/barrel_ecal_num_layers 1'                                  >> ${G4MACRO}
  echo '/gastpc/geometry/barrel_ecal_scint_thickness 60. cm'                        >> ${G4MACRO}
